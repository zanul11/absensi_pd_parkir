...
<div class="col-12">
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <h6 > LAPORAN DETAIL PEKERJAAN PER BAGIAN <br><?php echo $periode ?> </h6>
        </div>
    </div>
	<br>
	<div class="row">
		<div class="col-md-12">
            <b><p>BAGIAN : <?php echo $nama_bagian ?></p></b>
                    ...
                    <?php 
                     if(!empty($data_laporan)){
                        ...
                        foreach($data_laporan as $lap){ 
                            $group = ($sek!=$lap['cNmSeksi']?1:0);
                            if($group==1){ 
                                $sek = $lap['cNmSeksi']; ?>
                                <tr class="page-break">
                                    <td colspan="5"><b><?php echo 'Seksi : '.$lap['cNmSeksi'] ?></b></td>
                                </tr>
                            <?php } ?>                            
                            <tr class="page-break">
                                <td><?php echo $no ?></td>
