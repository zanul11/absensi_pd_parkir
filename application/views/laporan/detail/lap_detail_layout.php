     <!-- ============ Body content start ============= -->
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            <div class="breadcrumb">
                <h1>Laporan</h1>
                <ul>
                    <li><a href="#">Detail Pekerjaan</a></li>                    
                </ul>
            </div>
             ...
             <div class="col-md-12 mb-4">
                    <div class="card text-left">
                           ...
                           <div class="card-header">
                            <h4> Laporan Detail Pekerjaan  </h4>
                            ...
                            <form class="needs-validation" novalidate action="<?php echo base_url().'Laporan/Cetak' ?>" method="post" target="_blank">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 form-group mb-3">
                                        ...
                                        <select  name="bagian" id="bagian" required class="form-control select2" onchange="getSeksi()">
                                            <option value="ALL" >Keseluruhan</option>   									
                                            <?php if (!empty($data_bagian)){ foreach ($data_bagian as $bag) { ?>

                                                <option value="<?php echo $bag['cKdBagian'].'#'.$bag['cNmBagian'] ?>" ><?php echo $bag['cNmBagian'] ?></option>
                                            <?php }} ?>
                                        </select> 
                                    ...
                                    <div class="col-md-5 form-group mb-3">
                                        ...
                                        <select  name="seksi" id="seksi" class="form-control select2"> 									
                                        </select> 
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <input type="hidden" name="id_lap" value="DET">
