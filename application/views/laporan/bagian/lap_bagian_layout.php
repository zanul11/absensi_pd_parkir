                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 form-group mb-3">
                                        ...
                                        <select  name="pegawai" id="pegawai" required class="form-control select2" <?php echo ($action=="UpdateData"?'disabled':'') ?>>
                                            <option value="0#ALL" >Keseluruhan</option>   									
                                            <?php if (!empty($data_pegawai)){ foreach ($data_pegawai as $peg) {
                                                $selected = (isset($data_table)?($data_table['cNIK']==$peg['cNIK']?'selected':''):'');?>
                                                <option value="<?php echo $peg['cNIK'].'#'.$peg['cKdBagian'] ?>" <?php echo $selected ?> ><?php echo $peg['cNmPegawai'].' - Kabag '.$peg['cNmBagian'] ?></option>
                                            <?php }} ?>
                                        </select> 
                                    ...
                                    <div class="col-md-12">
                                        <input type="hidden" name="id_lap" value="BAG">
